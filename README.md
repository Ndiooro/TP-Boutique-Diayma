# Boutique Diayma
Question 8 : Analyse du flux d'exécution (Débogage)
Voici les étapes franchies par l'application avant l'affichage des produits sur l'écran d'accueil :
...
Méthode : Startup (Constructeur)



Préparation du Contrôleur de Produits
